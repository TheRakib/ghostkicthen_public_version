...
function IMFormComponent(props) {
  ...
  const [emailValueEdit, setEmailValueEdit] = useState(false);
  ...
  useEffect(() => {
    if (initialValuesDict.email === '' || !initialValuesDict.email) {
      setEmailValueEdit(true);
      return;
    }
  }, []);
      ...
      <View style={[styles.contentContainer]}>
        <View
          ...
          <Switch
            ...
            onValueChange={(value) =>
              onFormFieldValueChange(switchField, value)
            }
            style={{
      ...
      <View style={styles.contentContainer}>
        <View
          ...
          <TextInput
            ...
            editable={emailValueEdit ? true : formTextField.editable}
            onChangeText={(text) => {
